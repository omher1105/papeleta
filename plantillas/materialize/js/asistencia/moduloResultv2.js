...
$(document).ready(function (){
	readModule('readModuloResultv2');
});

$('#btnBack').on('click', function(e){
	writeModule('writeModuloResultv2', "#frm_modResult_v2", "modulo08v2");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModuloResultv2', "#frm_modResult_v2", "http://sigit.inei.gob.pe/sigitdesa/FCNLmonitoreo/");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModuloResultv2', "#frm_modResult_v2");
});
...
$("#frm_modResult_v2 :input").change(function() {
