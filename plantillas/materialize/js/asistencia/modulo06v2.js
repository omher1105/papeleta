...
$(document).ready(function (){
	readModule('readModulo06v2');
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo06v2', "#frm_mod06_v2", "modulo05v2");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo06v2', "#frm_mod06_v2", "modulo07v2");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo06v2', "#frm_mod06_v2");
});
...
$("#frm_mod06_v2 :input").change(function() {
