...
$(document).ready(function (){
	readModule('readModulo08');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo08', "#frm_mod08", "modulo07");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo08', "#frm_mod08", "moduloResult");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo08', "#frm_mod08");
});
...
$("#frm_mod08 :input").change(function() {
