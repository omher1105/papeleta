...
$(document).ready(function (){
	readModule('readModulo07');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo07', "#frm_mod07", "modulo06");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo07', "#frm_mod07", "modulo08");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo07', "#frm_mod07");
});
...
$("#frm_mod07 :input").change(function() {
