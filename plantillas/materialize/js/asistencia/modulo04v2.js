...
$(document).ready(function (){
	readModule('readModulo04v2');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo04v2', "#frm_mod04_v2", "modulo03v2");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo04v2', "#frm_mod04_v2", "modulo05v2");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo04v2', "#frm_mod04_v2");
});
...
$("#frm_mod04_v2 :input").change(function() {
