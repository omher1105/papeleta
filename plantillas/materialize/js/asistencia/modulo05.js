...
$(document).ready(function (){
	readModule('readModulo05');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo05', "#frm_mod05", "modulo04");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo05', "#frm_mod05", "modulo06");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo05', "#frm_mod05");
});
...
$("#frm_mod05 :input").change(function() {
