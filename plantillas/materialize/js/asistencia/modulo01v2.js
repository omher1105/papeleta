...
$(document).ready(function (){
	readModule('readModulo01v2');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo01v2', "#frm_mod01_v2", "http://sigit.inei.gob.pe/sigitdesa/FCNLmonitoreo/");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo01v2', "#frm_mod01_v2", "modulo03v2");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo01v2', "#frm_mod01_v2");
});
...
$("#frm_mod01_v2 :input").change(function() {
