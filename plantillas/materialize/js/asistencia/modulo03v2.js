...
$(document).ready(function (){
	readModule('readModulo03v2');	
});

$('#btnBack').on('click', function(e){
	writeModule('writeModulo03v2', "#frm_mod03_v2", "modulo01v2");
});

$('#btnNext').on('click', function(e){
	writeModule('writeModulo03v2', "#frm_mod03_v2", "modulo04v2");
});

$('#btnSave').on('click', function(e){
	writeModule('writeModulo03v2', "#frm_mod03_v2");
});

window.onload = function() {
  document.getElementById("C_OPE").focus();
};

$('#C_OPE').on('change', function(e){
	if($('#C_OPE').val()==2){
		disableContainer('P19', false);
		disableContainer('P20', false);
		disableContainer('P21', false);
		disableContainer('P22', false);
		disableContainer('P23', false);
...
$("#frm_mod03_v2 :input").change(function() {
...
function validate(){
	...
	if($('#C_OPE').val()!=2){
		...
		if($('#C_OPE').val()==-1){
			$("#C_OPE").addClass('unansweredQuestion');
			focus = focus || "C_OPE";
			isOk = false;
		}
		else{
